...
export const translations = {
  ...
  house: {
    ...
    livingItems: {
      hu: [
        ...
        "Okos TV, hatalmas projektor mozizás élményhez",
      ...
      en: [
        ...
        "Smart TV, large projector for a cinema experience",
  ...
  gallery: {
    ...
    imageAlts: [
      ...
      { hu: "Hálószoba – francia ágy", en: "Bedroom – king-size bed" },
      { hu: "Hálószoba – meleg fények", en: "Bedroom – warm lighting" },
      { hu: "Fürdőszoba – zuhanyzó", en: "Bathroom – walk-in shower" },
      { hu: "Fürdőszoba – kád", en: "Bathroom – bathtub" },
    ],
  },
