...
const Footer = () => {
  ...
  return (
    <footer className="bg-foreground text-background">
      {/* Map */}
      <div className="w-full h-80 opacity-70 grayscale hover:grayscale-0 transition-all duration-700 border-b border-background/10">
        <iframe
      ...
      <div className="container mx-auto px-6 py-16 max-w-5xl">
        <div className="text-center">
          ...
          <p className="font-body text-xs tracking-[0.3em] uppercase text-background/50 mb-8">{pick(t.subtitle, lang)}</p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-8">
            <a href="mailto:aura.vofi@gmail.com" className="flex items-center gap-2 font-body text-sm text-background/70 hover:text-background transition-colors">
          ...
          <div className="w-12 h-px bg-background/20 mx-auto mb-10" />

          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 text-[10px] text-background/40 font-body tracking-wider text-left border-t border-background/10 pt-10">
          ...
          <div className="mt-12 pt-8 border-t border-background/5 flex flex-col md:flex-row justify-between items-center gap-4 opacity-40 text-[9px]">
